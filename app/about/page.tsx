      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            A dedicated advocate with over 15 years of experience, committed to providing exceptional legal services 
            with unwavering dedication to justice and client satisfaction.
          </p>
        </motion.div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
                ...
                <p>
                  ...
                  across multiple practice areas. I believe in building strong client relationships based on trust, transparency, 
            ...
            <div className="bg-gradient-to-r from-white/5 to-white/10 p-6 rounded-xl border border-white/10">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">Laxminarayan Complex, Near Government Hospital, Dhrol</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            {qualifications.map((qual, index) => (
              <motion.div
                ...
                variants={cardVariants}
                whileHover={{ scale: 1.02 }}
                className="flex items-start space-x-6 p-6 rounded-xl bg-gradient-to-r from-white/5 to-white/10 border border-white/10 backdrop-blur-sm hover:border-yellow-400/30 transition-all duration-300"
              >
                <div className="w-16 h-16 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <BookOpen className="h-8 w-8 text-black" />
                </div>
                <div className="flex-1">
                  <h4 className="text-xl font-bold text-white mb-2">{qual.title}</h4>
                  <p className="text-yellow-400 font-semibold mb-1">{qual.institution} • {qual.year}</p>
        ...
        <motion.div variants={itemVariants} className="text-center">
          <div className="max-w-4xl mx-auto p-8 rounded-3xl bg-gradient-to-r from-yellow-400/10 to-yellow-600/10 border border-yellow-400/20 backdrop-blur-sm">
            ...
            <p className="text-gray-300 mb-8 text-lg">
              Contact me today to discuss your legal needs and discover how I can help you achieve the best possible outcome.
            </p>
